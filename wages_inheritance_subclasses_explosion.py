...
class SalariedEmployee(Employee):
    """Employee that's [aid based on a fixed monthly salary."""
...
class SalariedEmployeeWithCommission(SalariedEmployee):
    """Employee that's paid based on a fixed monthly salary and that gets a comission."""
    """Subclasses are exploding"""
    commission: float = 100
    contracts_landed: float = 0
...
class FreelancerWithCommission(Freelancer):
    """Freelancer that's paid based on number of worked hours and tha gets a commission"""
    """Subclasses Exploding"""
