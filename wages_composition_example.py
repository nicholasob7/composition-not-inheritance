...
class Commission(ABC):
    ...
    def get_payment(self) -> float:
        """Computes the commission to be paid"""


@dataclass
class ContractCommission(Commission):
    """Represents a comission."""
    """Subclasses are not exploding"""
...
class HourlyContract(Contract):
    """Contract type for an employee that is paid based on number of worked hours."""
...
class FreelancerContract(Contract):
    """Contract type for an employee that's paid based on a freelancer basis."""
